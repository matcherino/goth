...
func userFromReader(r io.Reader, user *goth.User) error {
	...
	user.Name = u.Data[0].FirstName + u.Data[0].LastName
	user.FirstName = u.Data[0].FirstName
	user.LastName = u.Data[0].LastName
	user.Email = u.Data[0].Email
	user.NickName = u.Data[0].DisplayName
	user.Location = u.Data[0].CountryCode
	user.UserID = u.Data[0].AccountID
